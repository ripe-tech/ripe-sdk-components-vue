...
| initialsProfile       | `Array`    | `false`  | The name of the profile to be used. A profile what what defines a premade configuration in a specific product. The configuration can set the values such as the font type, color and size, the initials position and rotation. This supports the use of namespacing.                                                                  |
| initialsProfiles      | `Array`    | `false`  | The name of the profiles to be used. A profile what what defines a premade configuration in a specific product. The configuration can set the values such as the font type, color and size, the initials position and rotation. This supports the use of namespacing.                                                                 |
...
| initialsDebug         | `Boolean`  | `false`  | Displays the Debug information box.                                                                                                                                                                                                                                                                                                   |
| fontFamily            | `String`   | `false`  | Overrides the initialsProfile's font to be applied on the initials.                                                                                                                                                                                                                                                                   |
| fontWeight            | `String`   | `false`  | Overrides the initialsProfile's font weight to be applied on the initials.                                                                                                                                                                                                                                                            |
| fontSize              | `String`   | `false`  | Overrides the initialsProfile's font size to be applied on the initials.                                                                                                                                                                                                                                                              |
